...
class FeatureDataset(Dataset):
    def __init__(self, data_path, target_path, is_train=True, transform=None):
...
train_dataset = FeatureDataset(data_path = r'D:\EEG_dataset\BCICIV_2a_npy\merged\merged_data.npy',
                                target_path=r'D:\EEG_dataset\BCICIV_2a_npy\merged\merged_label.npy',is_train=True)
train_dataloader = DataLoader(train_dataset,shuffle=True,batch_size=config.batch_size)

val_transforms = transforms.Compose([transforms.ToTensor()])
val_dataset = FeatureDataset(data_path = r'D:\EEG_dataset\BCICIV_2a_npy\merged\merged_data.npy',
                                target_path=r'D:\EEG_dataset\BCICIV_2a_npy\merged\merged_label.npy',is_train=False)
