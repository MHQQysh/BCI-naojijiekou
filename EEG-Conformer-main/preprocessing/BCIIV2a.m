...
% dir_1 = ['D:\EEG_dataset\BCICIV_2a_gdf\A0',num2str(subject_index),session_type,'.gdf']; % set your path of the downloaded data
% [s, HDR] = sload(dir_1);
% 
% % Label 
% label = HDR.Classlabel;
% labeldir_1 = ['D:\EEG_dataset\BCICIV_2a_gdf\true_labels\A0',num2str(subject_index),session_type,'.mat'];
% load(labeldir_1);
% label_1 = classlabel;
% 
...
dir_2= 'C:\Users\13613\Desktop\Naoji\EEG-Conformer-main\preprocessing\BCICIV_2a_gdf\A01E.gdf';
[s, HDR] = sload(dir_2);
...
% label = label_1;
% label = t_label + 1;
% saveDir = ['D:\EEG_dataset\BCICIV_2a_mat\A0',num2str(subject_index),'T.mat'];
% save(saveDir,'data','label');

data = data_2;
label = label_2;
saveDir = ['BCICIV_2a_mat',num2str(subject_index),'E.mat'];
save(saveDir,'data','label');
